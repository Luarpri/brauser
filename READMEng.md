# brauser
Si quieres la version en español, pulsa [aqui](https://github.com/Luarpri/brauser/blob/main/README.md)<br>
<br>
...
- Rakuten Kobo
- Wii U
- PS Vita (using [iTLS-Enso](https://github.com/SKGleba/iTLS-Enso) so it might not work the same on "clean" systems)
